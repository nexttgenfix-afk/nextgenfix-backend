...
const chefRequestSchema = new mongoose.Schema({
  requestId: {
    ...
    unique: true,
    // index created below with chefRequestSchema.index({ requestId: 1 }, { unique: true })
  },
  // unique index declared below with chefRequestSchema.index({ requestId: 1 }, { unique: true })
